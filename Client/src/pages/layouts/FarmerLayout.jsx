...
const styles = `
  ...
  .farmer-topbar-btn:hover {
    background: #dcfce7;
    border-color: #4ade80;
  }

  .farmer-content { padding: 2rem; }
`;
...
const navItems = [
  {
    to: "/farmer/dashboard",
    label: "Dashboard",
    icon: <svg className="nav-icon" viewBox="0 0 16 16" fill="currentColor"><path d="M8 4a.5.5 0 01.5.5V6a.5.5 0 01-1 0V4.5A.5.5 0 018 4zM3.732 5.732a.5.5 0 01.707 0l.915.914a.5.5 0 11-.708.708l-.914-.915a.5.5 0 010-.707zM2 10a.5.5 0 01.5-.5h1.586a.5.5 0 010 1H2.5A.5.5 0 012 10zm9.5 0a.5.5 0 01.5-.5h1.5a.5.5 0 010 1H12a.5.5 0 01-.5-.5zm.754-4.246a.389.389 0 00-.527-.02L7.547 9.31a.91.91 0 101.302 1.258l3.434-4.297a.389.389 0 00-.029-.518z"/><path d="M0 10a8 8 0 1115.547 2.661c-.442 1.253-1.845 1.602-2.932 1.25C11.309 13.488 9.475 13 8 13c-1.474 0-3.31.488-4.615.911-1.087.352-2.49.003-2.932-1.25A7.988 7.988 0 010 10z"/></svg>,
  },
  {
    to: "/farmer/contracts",
    label: "Contracts",
      ...
      <aside className="farmer-sidebar">
        <div className="farmer-header">
          <div className="farmer-brand">
            <div className="farmer-brand-icon">🌱</div>
            <span className="farmer-brand-name">AgriHub</span>
          </div>
        ...
        <nav className="farmer-nav">
          ...
          {navItems.map((item) => (
            <Link
              key={item.to}
              to={item.to}
              className={`farmer-nav-link ${location.pathname === item.to ? "active" : ""}`}
            >
              {item.icon}
              {item.label}
            </Link>
        ...
        <div className="farmer-stats-card">
          ...
          <div className="farmer-stats-row">
            <div className="farmer-stat">
              <div className="farmer-stat-num">12</div>
              <div className="farmer-stat-desc">Active</div>
            </div>
            <div className="farmer-stat">
              <div className="farmer-stat-num">3</div>
              <div className="farmer-stat-desc">Pending</div>
            </div>
            <div className="farmer-stat">
              <div className="farmer-stat-num">₹2L</div>
              <div className="farmer-stat-desc">Earned</div>
            </div>
          </div>
        </div>
        ...
        <div className="farmer-footer">
          <div className="farmer-user-pill">
            ...
            <div>
              <div className="farmer-user-name">Admin</div>
              <div className="farmer-user-role">Verified Farmer</div>
            </div>
          </div>
        </div>
      </aside>
      ...
      <main className="farmer-main">
        <div className="farmer-topbar">
          ...
          <div className="farmer-topbar-actions">
            <div className="farmer-topbar-btn">
